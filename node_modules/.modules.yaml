...
hoistedDependencies:
  ...
  /cookie/0.5.0:
    cookie: private
  /create-jest/29.7.0(@types/node@18.15.11)(ts-node@10.9.1):
    create-jest: private
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@18.15.11)(ts-node@10.9.1):
    jest-cli: private
  /jest-config/29.7.0(@types/node@18.15.11)(ts-node@10.9.1):
    jest-config: private
  /jest-diff/29.7.0:
    jest-diff: private
  ...
  /jest-worker/29.7.0:
    jest-worker: private
  /jest/29.7.0(@types/node@18.15.11)(ts-node@10.9.1):
    jest: private
  /js-tokens/4.0.0:
    js-tokens: private
  /js-yaml/3.14.1:
...
pendingBuilds: []
prunedAt: Tue, 16 Jan 2024 17:33:00 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
